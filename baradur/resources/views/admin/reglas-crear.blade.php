...
<div class="container pb-3">
    ...
    <div class="row">
      <h3 class="col pt-2">Crear regla de prioridad</h3>
    </div>
    <hr class="mb-3 mt-0">
    ...
    <div class="editor">
      ...
      <form action="{{ route('reglas.store') }}" method="post">
        ...
        <div class="form-group">
          ...
          value="{{ $old->descripcion }}" autofocus placeholder="Ingrese la descripción">
        </div>
        ...
        <div class="form-group col-6 pl-0 mt-3">
          <label for="formControlRange" id="texto_prioridad">Prioridad: {{ $old->pondera or 0 }}</label>
          <input type="range" id="prioridad" class="form-control-range mt-2" name="prioridad" 
            min="0" max="100" step="5" value="{{ $old->pondera or 0 }}">
        </div>
