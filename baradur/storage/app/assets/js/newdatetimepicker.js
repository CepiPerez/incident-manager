			...
			datetimepicker.on('open.xdsoft',function(){
				...
				if( onShow!==false ){
					var setPos = function(){
						...
						//console.log('LEFT:' + offset.left + ' - SCREEN:'+ document.body.offsetWidth
						//		+ ' - THIS:' + (datetimepicker[0].offsetWidth+ offset.left));

						var offset_left = (datetimepicker[0].offsetWidth+ offset.left);
						var left_pos = offset.left;

						if (offset_left > document.body.offsetWidth)
						{
							left_pos = document.body.offsetWidth - 330;
							//console.log('NEW LEFT POSITION: ' + left_pos);
						}
