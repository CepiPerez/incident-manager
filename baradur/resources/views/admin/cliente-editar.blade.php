...
<div class="container pb-3">
    ...
    <div class="card p-3">
      ...
      <form action="{{ route('clientes.modificar', $cliente->codigo) }}" method="post" autocomplete="off">
        @csrf
        @method('put')
        ...
        <button type="submit" class="col-auto btn btn-primary mt-3">Guardar cambios</button>
