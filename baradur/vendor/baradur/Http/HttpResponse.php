...
class HttpResponse
{
    ...
    public function getHeader($name) {
        ...
        return isset($this->header_names[$name]) ? $this->headers[$this->header_names[$name]] : array();
    }
    ...
    public function withHeader($name, $value) {
        ...
        $value = array_map(array($this, 'trimHeaderValue'), $value);
    ...
    private function setHeaders() {
        ...
        foreach ($raw_headers as $raw_header) {
            if (strpos($raw_header, ':') !== false) {
                ...
                list($key, $value) = array_map(array($this, 'trimHeaderValue'), explode(':', $raw_header, 2));
