...
#
# ------------------------------
# Modified for Baradur Framework
...
class Hash
{
	...
	/* public static function PasswordHash($iteration_count_log2, $portable_hashes)
	{
    ...
    {
        $actualHash = self::make('');

		return substr($actualHash, 0, 12) != substr($hashedValue, 0, 12);
    }
