          ...
          <div class="list-group">
            ...
            <ul class="list-unstyled mt-2 mb-0" id="submenu">
              ...
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'incidentes') &&
                  !Str::contains(Route::currentRouteName(),'incidentes.create')) active @endif">
            ...
            <ul class="list-unstyled mt-4" id="submenu">
              ...
              @can ('admin_usuarios')
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'usuarios')) active @endif">
              ...
              @can ('admin_grupos')
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'grupos')) active @endif">
              ...
              @can ('admin_clientes')              
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'clientes')) active @endif">
              ...
              @can ('admin_modulos')              
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'modulos')) active @endif">
              ...
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'tipoincidentes')) active @endif">
              ...
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'tipoavances')) active @endif">
              ...
              @if (Auth::user()->rol==1)              
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'prioridades') ||
              ...
              @if (Auth::user()->rol==1)              
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'asignaciones') ||
              ...
              @if (Auth::user()->rol==1)              
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'herramientas') ||
        ...
        <nav class="d-inline d-sm-none mobile-sidebar" id="navbar">
          <div class="list-group">
            ...
            <ul class="list-unstyled mt-2 mb-0" id="submenu">
              ...
              <li class="sidebaritem @if(Str::contains(Route::currentRouteName(),'incidentes') ||
                  Str::contains(Route::currentRouteName(),'incidente.editar')) active @endif">
                  <a href="{{ route('incidentes.index') }}">
                    <i class="ri-chat-4-line"></i>
                    <span>Lista de incidentes</span>
                  </a>
